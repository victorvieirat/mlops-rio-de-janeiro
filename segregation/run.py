...
Date: 01 Jan. 2022
After the clean data step is necessary to split the preprocessed data
...
def process_args(args):
    ...
    """
    run = wandb.init(project="mlops-rio-de-janeiro-segregation", job_type="data_segregation")
